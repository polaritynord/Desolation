...
function weaponItem.new(weaponData)
    ...
    local src = assets.images.weapons[string.lower(instance.weaponData.name) .. "Img"]
    instance.quad = love.graphics.newQuad(0, 0, src:getWidth(), src:getHeight(), src:getDimensions())
